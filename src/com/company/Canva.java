...
public class Canva extends JPanel {
    ...
    private void setButtons() {
        ...
        readButton.setBounds(50,25,100,25);

        readButtonJPG.setBounds(50,225,100,25);
        readButtonJPG.addActionListener(e-> readFileJPG(pathFileJPG.getText()));
        readButtonJPG.setText("Read JPG");

        writeButtonJPG.setBounds(50,275,100,25);
        writeButtonJPG.addActionListener(e-> writeFileJPG(pathFileJPG.getText()));
        writeButtonJPG.setText("Write JPG");

        labelHeight.setBounds(10,175,100,25);
        labelWidth.setBounds(10,125,100,25);
        labelName.setBounds(10,75,100,25);

        pathFile.setBounds(50,75,100,25);
        widthToLoad.setBounds(50,125,100,25);
        heightToLoad.setBounds(50,175,100,25);
        pathFileJPG.setBounds(50,325,100,25);
